...
class RAGEngine:
    ...
    def _build_prompt(
        ...
        prompt = f"""أنت مساعد إخباري محترف ومتخصص في أخبار الجزيرة نت.
...
تعليمات العمل:
1. استخدم السياق المتوفر فقط للإجابة دون إضافة معرفة خارجية.
2. اكتب الإجابة مباشرة بصياغة خبرية دقيقة وموجزة.
3. لا تذكر أنك ستجيب بناءً على السياق، ولا تذكر القيود أو خطوات التفكير.
4. إذا لم يتضمن السياق معلومات كافية للإجابة، قل فقط: لا أملك معلومات كافية.
